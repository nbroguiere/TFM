...
for t=timepoints_to_process
    for k=1:nz
        ...
        % Pick up the pressure vectors in this range:
        ...
        pressure_vectors_tmp=pressure_vector{t}(indices,:);
        
        % Plot the vector field:
        quiver(positions_tmp(:,2)/pxsize_xy*f_pic,positions_tmp(:,1)/pxsize_xy*f_pic,pressure_vectors_tmp(:,2)/pxsize_xy*f_P*f_pic,pressure_vectors_tmp(:,1)/pxsize_xy*f_P*f_pic,0,'color','b');
...
if save_overlay_fitted
    ...
    filename='output\overlay_pressure_stack.tif';
